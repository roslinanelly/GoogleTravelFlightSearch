...
#      | Singapore | Dubai         | September 2, 2024    | One way         | Infants in seat | 2                   | Premium economy |
  ...
  Scenario: Verify add flight is enabled when multi-city tickets are selected and user can add and remove multiple stop-overs
    Given The Google Travel Flight Search page is loaded successfully
    When User updates ticket type "Multi-city"
    Then User can add multiple flights
      | Melbourne | Canberra      | April 10, 2024      |
      | Canberra  | Sydney        | June 30, 2024       |
      | Sydney    | Bali          | July 2, 2024        |
